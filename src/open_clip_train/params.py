...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        help="Which optimizer to use. Choices are ['adamw', 'custom_opt', 'hybrid_opt', or any timm optimizer 'timm/{opt_name}']."
    )
    parser.add_argument(
        "--use-bn-sync",
        default=False,
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Enable Information Bottleneck Module (IBM) for distillation."
    )
    parser.add_argument(
        "--pretrain-ibm",
        default=False,
        action="store_true",
        help="Pretrain the Information Bottleneck Module."
    )
    parser.add_argument(
        "--tsne-log-frequency",
        type=int,
        default=0,
        help="Frequency (in steps) to generate t-SNE visualization plots. Set to 0 to disable."
    )
    parser.add_argument(
        "--tsne-sample-size",
        type=int,
        default=500,
        help="Number of samples to use for t-SNE visualization (to manage memory usage)."
    )
    parser.add_argument(
        "--enable-tsne-logging",
        default=False,
        action="store_true",
        help="Enable t-SNE feature visualization logging to TensorBoard."
    )
    # parser.add_argument(
    #     "--teacher-image-features-path",
    #     type=str,
    #     default=None,
    #     help="Path to precomputed teacher image features (.pth file)"
    # )
    # parser.add_argument(
    #     "--teacher-text-features-path", 
    #     type=str,
    #     default=None,
    #     help="Path to precomputed teacher text features (.pth file)"
    # )
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Weight for standard CLIP loss"
    )
    parser.add_argument(
        "--alpha-distill",
        type=float,
